...
#define PROGRAM_NAME		"ccminer-cdii"
...
int main(int argc, char *argv[])
{
	...
	printf("*** ccminer " PACKAGE_VERSION " for nVidia GPUs by cdii@github ***\n");
	if (!opt_quiet) {
		...
		printf("GRLC donation address: GJXznGsiT9u3oRqtgFQbcYF9MzJf1caqCp (cdii)\n\n");
	}
